...
export class PagamentoAvulsoController {
    ...
    @ApiQuery({ name: 'apagado', required: false, type: Boolean, description: 'true para listar apenas apagados; false para nao apagados' })
    ...
    @ApiParam({ name: 'id', type: Number })
    @ApiQuery({ name: 'apagado', required: false, type: Boolean, description: 'true para buscar pagamento apagado; false para nao apagado' })
    @ApiOkResponse({ type: PagamentoAvulsoResponseDto })
