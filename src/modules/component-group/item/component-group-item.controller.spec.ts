...
describe('ComponentGroupItemController', () => {
    let controller: ComponentGroupItemController;
    ...
    beforeEach(async () => {
        const module: TestingModule = await Test.createTestingModule({
            ...
            providers: [
                {
                    provide: ComponentGroupItemService,
                    useValue: {
        ...
        controller = module.get<ComponentGroupItemController>(ComponentGroupItemController);
    ...
    describe('/ (POST)', () => {
        it('should return a new component group item', async () => {
            // Arrange
            const groupId = 1;
            const componentGroupItem: AddComponentGroupItemDto = { componentId: 'ADMFM001' };
